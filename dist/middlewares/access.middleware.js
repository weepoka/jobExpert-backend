...
const validateAccess = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.log(error);
        next(http_errors_1.default.Unauthorized("Your session has expired, please login"));
    }
});
